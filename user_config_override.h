...
#ifdef WITH_STA1
  #undef STA_SSID1
  #define STA_SSID1              "keenetic"        // [Ssid1] Wifi SSID

  #undef STA_PASS1
  #define STA_PASS1              "uzf3PDK3"        // [Password1] Wifi password
#endif
...
#ifdef ESP_CONFIG
  #undef PROJECT
  #define PROJECT                "esp"           // PROJECT is used as the default topic delimiter

  #undef MODULE
  #define MODULE                 WEMOS           // [Module] Select default model from sonoff_template.h (Should not be changed)

  #undef MQTT_GRPTOPIC
  #define MQTT_GRPTOPIC          "esps"       // [GroupTopic] MQTT Group topic

  #undef FRIENDLY_NAME
  #define FRIENDLY_NAME          "ESP"           // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
#endif
